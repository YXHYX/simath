...
// Maps CP437 bytes [128-255] directly to UTF-16 WCHAR values
const WCHAR CP437_TO_WCHAR[128] = {
...
WCHAR cp437_to_wchar(BYTE cp437_byte) {
	if (cp437_byte < 128) {
		return static_cast<WCHAR>(cp437_byte);
	}
	return CP437_TO_WCHAR[cp437_byte - 128];
}
